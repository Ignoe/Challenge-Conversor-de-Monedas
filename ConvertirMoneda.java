...
public class ConvertirMoneda {
    ...
    public static void convertir(String monedaBase, String monedaTarget, ConsultarMoneda consulta, Scanner lectura) {
        ...
        System.out.println("La tasa de cambio actual es: " + monedaBase + " = " + monedas.conversion_rate() + " " + monedaTarget);
    ...
    public static void convertirOtraMoneda(ConsultarMoneda consulta, Scanner lectura) {
        ...
        String monedaDeseada = lectura.nextLine().toUpperCase();
        convertir(monedaBase, monedaDeseada, consulta, lectura);
    }
}
